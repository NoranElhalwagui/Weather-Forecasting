...
def fetch_weather(start_date, end_date):
    ...
    params = {
        ...
        "end_date": end_date,
        "hourly": ["temperature_2m", "relative_humidity_2m", "precipitation", "wind_speed_10m", "wind_direction_10m", "precipitation_probability", "cloud_cover", "wind_gusts_10m", "visibility", "weather_code", "apparent_temperature", "dew_point_2m"],
    }
